import fs from 'fs';
import type { ResponseLike } from 'llm_multiple/internal/to-file';
import { toFile } from 'llm_multiple/core/uploads';
...
describe('missing File error message', () => {
  ...
  test('is thrown', async () => {
    const uploads = await import('llm_multiple/core/uploads');
    await expect(
